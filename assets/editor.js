...
console.log( "admin -------------- editor" + '/attachment/' + form.dataset.id + 'container name: ' + form.dataset.container );


tinymce.init({

    selector: '#' + form.dataset.container,
    ...
    */
    images_upload_url: '/attachment/' + form.dataset.id + '/' + form.dataset.type,
